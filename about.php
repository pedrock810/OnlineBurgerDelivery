          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Burger World</span></h2>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Burger World</strong></h3>
            <h3><strong>The Worldwide Leader in Burger Delivery</strong></h3>
            <p class="font-italic">
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="https://github.com/pedrock810/" target="_blank"><i class="fab fa-github"></i></a>
                  <a href="https://www.instagram.com/pedrock_810/" target="_blank"><i class="fab fa-instagram" target="_blank"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="https://github.com/Baisuk/" target="_blank"><i class="fab fa-github"></i></a>
                  <a href="https://www.instagram.com/rivaldopinto26/" target="_blank"><i class="fab fa-instagram" target="_blank"></i></a>
                </div>
              </div>
            </div>
          </div>
